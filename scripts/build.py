...
for name in ('index.html', 'coffee-script.ttf', 'coffee-font-license.txt', 'me.jpg', 'favicon.svg', 'buy-me-a-coffee.png', 'weather-observatory.png', 'di-lab.jpg'):
...
def redirect(route, target):
    ...
    (folder / 'index.html').write_text(
        ...
        f'<link rel="canonical" href="https://ruzcko.com{url}">'
